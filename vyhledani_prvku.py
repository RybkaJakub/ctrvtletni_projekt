...
def row_period(row, found_data):
    ...
    print(f"Protonove cislo: {row['NumberofProtons'] if row['NumberofProtons'] != '' else 'Žádné'}")
    print(f"Elektronove cislo: {row['NumberofElectrons']}")
    print(f"Neutronove cislo: {row['NumberofNeutrons'] if row['NumberofNeutrons'] != '' else 'Žádné'}")
    print(f"Periodicke cislo: {row['Period'] if row['Period'] != '' else 'Žádné'}")
    print(f"Cislo skupiny: {row['Group'] if row['Group'] != '' else 'Žádné'}")
    print(f"Radioaktivni: {'Ano' if row['Radioactive'] == 'yes' else 'Ne'}")
    print(f"Naturalní: {'Ano' if row['Natural'] == 'yes' else 'Ne'}")
